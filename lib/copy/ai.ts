...
export const AI_COPY = {
  settings: {
    ...
    subtitle:
      'Add items by typing or speaking, get warmer recommendations, and ask questions about your money. Anonymized data is sent to Anthropic. Free for 50 actions a month.',
    quotaLabel: 'AI actions this month',
    resetDev: 'Reset quota cache',
  },
  enablePrompt: {
    title: 'Enable AI Assist?',
    body: 'Turn on AI to add items by voice or text, get warmer recommendations, and ask about your spending. It’s free for 50 actions a month, and only anonymized data is sent.',
    cta: 'Open Settings',
    cancel: 'Not now',
  },
  assistant: {
    ...
    quotaExhausted: 'You’ve used all 50 free AI actions this month. Resets next month.',
